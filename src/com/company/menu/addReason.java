...
public class addReason extends JFrame implements ActionListener{
    ...
    public addReason() throws IOException {
        p1=new JPanel();
        p1.setBounds(5,10,480,350);
        p1.setLayout(null);
        p1.setBorder(BorderFactory.createTitledBorder("Reason"));
        try {
            file = new BufferedWriter(new FileWriter("Reason.txt", true));
        ...
        l.addElement("");
        File f = new File("D:/akash/Agri_Management_System/Reason.txt");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            try {
                Calf_Management.h.model.addElement(s);
                file.write(s);
                file.newLine();
                file.flush();
            } catch (Exception exception) {
