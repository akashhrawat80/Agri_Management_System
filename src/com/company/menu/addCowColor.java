...
public class addCowColor extends JFrame implements ActionListener, Serializable {
    ...
    public addCowColor() throws IOException {
        JLabel l1 = new JLabel("<html><i>Add Cow Colour<i><html>");
        l1.setBounds(10, 10, 100, 15);
        add(l1);
        try {
            file = new BufferedWriter(new FileWriter("Cow_Colour_addition.txt", true));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            if (i == 0) {
                l.clear();
                try {
                    file = new BufferedWriter(new FileWriter("Cow_Colour_addition.txt"));
                    file.write("");
                } catch (IOException exception) {
                    exception.printStackTrace();
