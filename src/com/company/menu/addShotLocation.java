...
public class addShotLocation extends JFrame implements ActionListener{
    ...
    public addShotLocation() throws IOException {
        p1=new JPanel();
        p1.setBounds(5,10,480,350);
        p1.setLayout(null);
        p1.setBorder(BorderFactory.createTitledBorder("Shot Location"));
        try {
            file = new BufferedWriter(new FileWriter("Shot_Location_health.txt", true));
        ...
        l.addElement("");
        File f = new File("D:/akash/Agri_Management_System/Shot_Location_health.txt");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            l.addElement(s);
            try {
                Calf_Management.h.model2.addElement(s);
                file.write(s);
                file.newLine();
                file.flush();
            } catch (Exception exception) {
