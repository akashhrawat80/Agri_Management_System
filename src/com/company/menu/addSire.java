...
public class addSire extends JFrame implements ActionListener, Serializable {
    ...
    public addSire() throws IOException {
        p1=new JPanel();
        p1.setBounds(0,0,480,460);
        p1.setLayout(null);
        p1.setBorder(BorderFactory.createTitledBorder("Sire"));
        JLabel l1 = new JLabel("<html><i>Sire Info<i><html>");
        l1.setBounds(60, 10, 100, 15);
        p1.add(l1);
        try {
            file = new BufferedWriter(new FileWriter("Sire.txt", true));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            if (i == 0) {
                l.clear();
                try {
                    file = new BufferedWriter(new FileWriter("Sire.txt"));
                    file.write("");
                } catch (IOException exception) {
                    exception.printStackTrace();
