...
public class addAdministrator extends JFrame implements ActionListener{
    ...
    public addAdministrator() throws IOException {
        p1=new JPanel();
        p1.setBounds(5,10,480,350);
        p1.setLayout(null);
        p1.setBorder(BorderFactory.createTitledBorder("Administrator"));
        try {
            file = new BufferedWriter(new FileWriter("administrator_health.txt", true));
        ...
        l.addElement("");
        File f = new File("D:/akash/Agri_Management_System/administrator_health.txt");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            l.addElement(s);
            try {
                Calf_Management.h.model44.addElement(s);
                file.write(s);
                file.newLine();
                file.flush();
            } catch (Exception exception) {
