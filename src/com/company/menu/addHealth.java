...
public class addHealth extends JFrame implements ActionListener, Serializable {
    ...
    public addHealth() throws IOException {
        JLabel l1 = new JLabel("<i>Add Cow Health_Code<i>");
        l1.setBounds(10, 10, 100, 15);
        add(l1);
        try {
            file = new BufferedWriter(new FileWriter("Health_Code.txt", true));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            if (i == 0) {
                l.clear();
                try {
                    file = new BufferedWriter(new FileWriter("Health_Code.txt"));
                    file.write("");
                } catch (IOException exception) {
                    exception.printStackTrace();
