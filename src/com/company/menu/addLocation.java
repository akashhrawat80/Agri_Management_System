...
public class addLocation extends JFrame implements ActionListener, Serializable {
    ...
    public addLocation() throws IOException {
        ...
        JLabel l1 = new JLabel("<html><i>Add Location<i><html>");
        l1.setBounds(60, 10, 100, 15);
        p1.add(l1);
        try {
            file = new BufferedWriter(new FileWriter("Location.txt", true));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == cancel) {
            ...
            if (i == 0) {
                l.clear();
                try {
                    file = new BufferedWriter(new FileWriter("Location.txt"));
                    file.write("");
                } catch (IOException exception) {
                    exception.printStackTrace();
