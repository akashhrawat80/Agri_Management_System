...
public class Enter extends JFrame implements ActionListener {
    ...
    Enter(){
        ...
        ImageIcon img2=new ImageIcon(ClassLoader.getSystemResource("com/company/images/1q.jpg"));
    ...
    public void actionPerformed(ActionEvent e){
        //ActionEvent helps to differentiate between the buttons
        if(e.getSource()==but1) {
            ...
            if(str.equals("") || password.equals("")||(str.equals("") && password.equals(""))) {
                ...
                try {
                    ...
                    if (r.next()) {//if matches then next page opens else not
                        ...
                        JOptionPane.showMessageDialog(this, "Not Valid!");//message dialog opens
                        //this.setVisible(false);
                    }
                } catch (Exception ee) {
